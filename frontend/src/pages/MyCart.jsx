  ...
  return (
    <div
      className={`${
        cartPage
          ? ""
          : "w-full max-w-4xl bg-white shadow-lg  rounded-2xl px-8 mt-10 py-4 md:-mt-1"
      }`}
    >
      {cartPage && <Navbar />}
      <div
      ...
      >
        ...
        <div className="space-y-5">
          {user.cart.length == 0 ? (
            <p className="text-md text-gray-400">No item is in the cart</p>
          ) : (
