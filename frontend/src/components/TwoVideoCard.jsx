...
const TwoVideoCard = (props) => {
  return (
    <div className={`flex flex-col md:flex-row items-center gap-6 justify-evenly px-2  py-2 pb-4   bg-white shadow-lg rounded-2xl w-[95%] ${props.isMobile?"mx-2":"mx-10"}  mt-10`}>
      <div className={`${props.isMobile?"w-[85%]":"w-[50%]"}`}>
      ...
      {!props.isMobile &&<div className="w-[50%]">
        <VideoCard videoSrc={props.videoSrc} />
        <div>
          <h2 className="text-2xl font-bold mb-3">
            Discover the Latest Trends
